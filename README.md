...
NOTE: if the instructions are still unclear, find a detailed step by step guide here https://github.com/Darakah/obsidian-timelines/issues/2
...
- Background Image:
  ...
  - Currently only `http` & `absolute local path` will render, in the current obsidian release of `v0.10.13` obsidian links for background images are blocked from rendering, hopefully it is promised that this will be removed in the upcuming `v0.10.14` release. 
